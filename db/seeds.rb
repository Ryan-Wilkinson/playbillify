...
ad_fourteen = Ad.create(size: "half-page", price: "115.00", event_id: event_three.id, dimensions: '200 x 300', updated_at: DateTime.strptime("04/202017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: 'advertiser.id')
