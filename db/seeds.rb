...
ad_fourteen = Ad.create(size: "half-page", price: "115.00", event_id: event_three.id, dimensions: '200 x 300', updated_at: DateTime.strptime("04/17/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: 'advertiser.id')
...
ad_sixteen = Ad.create(size: "quarter-page", price: "75.00", event_id: event_three.id, dimensions: '200 x 300', updated_at: DateTime.strptime("04/21/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: 'advertiser.id')
ad_seventeen = Ad.create(size: "full-page", price: "175.00", event_id: event_three.id, dimensions: '100 x 200', updated_at: DateTime.strptime("04/28/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: 'advertiser.id')
ad_eighteen = Ad.create(size: "quarter-page", price: "50.00", event_id: event_three.id, dimensions: '200 x 300', updated_at: DateTime.strptime("05/01/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: 'advertiser.id')
ad_twenty = Ad.create(size: "half-page", price: "115.00", event_id: event_three.id, dimensions: '200 x 300', advertiser_id: 'advertiser.id')
ad_twenty_three = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200', updated_at: DateTime.strptime("05/02/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: 'advertiser.id')
...
ad_twenty_seven = Ad.create(size: "quarter-page", price: "75.00", event_id: event_three.id, dimensions: '200 x 300', updated_at: DateTime.strptime("05/04/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: advertiser.id)
ad_twenty_eight = Ad.create(size: "full-page", price: "175.00", event_id: event_three.id, dimensions: '100 x 200', updated_at: DateTime.strptime("05/05/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: 'advertiser.id')
ad_twenty_nine = Ad.create(size: "quarter-page", price: "50.00", event_id: event_three.id, dimensions: '200 x 300', updated_at: DateTime.strptime("05/07/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: advertiser.id)
ad_thirty = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200', updated_at: DateTime.strptime("05/09/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: advertiser.id)
ad_forty = Ad.create(size: "half-page", price: "115.00", event_id: event_three.id, dimensions: '200 x 300', updated_at: DateTime.strptime("05/11/2017 17:00", "%m/%d/%Y %H:%M"), advertiser_id: advertiser.id)

ad_forty_on = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_two= Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_three = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_four = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_five = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_six = Ad.create(size: "half-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_seven = Ad.create(size: "half-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_eight = Ad.create(size: "half-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_forty_nine = Ad.create(size: "half-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_fifty = Ad.create(size: "quarter-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_fifty_one = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_fifty_two = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
ad_fifty_three = Ad.create(size: "full-page", price: "200.00", event_id: event_three.id, dimensions: '100 x 200')
