...
ad_one = Ad.create(size: "eighth-page", price: "5.50", event_id: event.id, dimensions: '100 x 200')
ad_two = Ad.create(size: "quarter-page", price: "30.50", event_id: event.id, dimensions: '200 x 300')
ad_three = Ad.create(size: "full-page", price: "5.50", event_id: event.id, dimensions: '100 x 200', advertiser_id: 'advertiser.id')
ad_four = Ad.create(size: "half-page", price: "30.50", event_id: event.id, dimensions: '200 x 300', advertiser_id: 'advertiser.id')
